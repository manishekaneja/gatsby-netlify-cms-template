...
export const IntroSlidingCard = ({ position }) => {
  return (
    ...
    >
      ...
      >
        <div className="h-3/6 flex flex-wrap items-center justify-center ">
          <div className="mx-2 text-5xl h-30">
            <CharacterRandomizer string="side" />
          </div>
          <div className="text-5xl h-30 mx-2">
            <CharacterRandomizer string="projects" />
          </div>
          <div className="text-5xl h-30 mx-2">
